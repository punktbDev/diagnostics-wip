...
if (localStorage.getItem("test-end")) {
    location.href = "/testing-end.html?test-name=antiratingOfProfessionsKid"
}
...
let questionsHash = JSON.parse(localStorage.getItem("questionsHash_antiratingOfProfessionsKid"))
